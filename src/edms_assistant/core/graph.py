# src/edms_assistant/core/graph.py
...
from src.edms_assistant.core.agent_registry import agent_registry  # Импортируем
from src.edms_assistant.agents.agent_factory import AgentFactory  # Импортируем *класс*
...
from src.edms_assistant.infrastructure.llm.llm import get_llm, get_embeddings
from src.edms_assistant.core.settings import settings  # Импортируем настройки
import logging
