...
const AssistantWidget = () => {
    ...
    // === API-методы через централизованный assistantApi ===
            ...
            {(isOpen || isClosing) && (
                ...
                >
                    ...
                    <div className="flex-1 flex overflow-hidden">
                        ...
                        {isChatPanelOpen && (
                            <div
                                className="w-[200px] bg-gray-800 text-white flex flex-col mr-4 rounded-tl-2xl rounded-bl-2xl border-r border-gray-700">
